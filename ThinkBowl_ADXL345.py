...
class ADXL345:
	...
	def setInactivityThreshold(self, g=-1, axis='z'):
		...
		if intervals < 256:
			self.bus.write8(self.InactivityThreshold, intervals)
	...
	def getRawAxes(self):
		return self.bus.readList(self.XAxisDataLSB, 6)
	
	def getAxes(self):
		scaleFactor = (self.axesScale*2)/1024
		accel_x = self.readS16(self.XAxisDataLSB)
		accel_y = self.readS16(self.YAxisDataLSB)
		accel_z = self.readS16(self.ZAxisDataLSB)
